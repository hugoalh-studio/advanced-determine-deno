...
export const bytesMatcherLotus123SpreadsheetV1: BytesMatcher = new BytesMatcher("00 00 02 00 06 04 06 00 08 00 00 00 00 00");
/**
...
export function isByteLotus123SpreadsheetV1(item: Uint8Array): boolean {
	return bytesMatcherLotus123SpreadsheetV1.test(item);
}
