...
export const bytesMatcherLZH0: BytesMatcher = new BytesMatcher().addExactStartGroupHex(2, "2D 68 6C 30 2D").freeze();
export const bytesMatcherLZH5: BytesMatcher = new BytesMatcher().addExactStartGroupHex(2, "2D 68 6C 35 2D").freeze();
/**
