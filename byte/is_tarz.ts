...
export const bytesMatcherTarZLZH: BytesMatcher = new BytesMatcher().addExactGroupHex(0, "1F A0").freeze();
export const bytesMatcherTarZLZW: BytesMatcher = new BytesMatcher().addExactGroupHex(0, "1F 9D").freeze();
/**
